...
export default function Nosotros() {
    return (
        <div className="nosotros-container">
            <img
                src="https://lh3.googleusercontent.com/p/AF1QipM37YGmH8NLEx4oWm9yRTPJcsNoGdSn9NmE5xEt=w1080-h608-p-no-v0"
                alt="imagen como nuevo"
                style={{
                    width: '900px',
                    height: '350px',
                    display: 'block',
            ...
            <div className="texto-importante">
                ...
                <p>Apoyando la economía circular, antes de reciclar lo mejor es reparar, dándole muchas oportunidades a tus artículos para que estén siempre Como Nuevos ! 🙂 Mas de 20.000 pares de zapatos reparados en 10 años ! ♻️</p>
            </div>
            ...
            <h3 className="titulo-seccion">Valores:</h3>
            <ul className="valores">
                <li>Respeto</li>
                <li>Cumplimiento</li>
                <li>Transparencia</li>
